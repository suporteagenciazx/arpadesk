...
export function FinanceIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function UsersIcon({ size = 18, className = "" }) {
  return (
    ...
    >
      ...
      <path d="M14 20c.3-2.2 2.4-4 5-4" />
    </svg>
  );
}
...
export function ExpenseIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function FloppyDiskIcon({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function FineIcon({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function PanelLeftIcon({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function FilesIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AutomationIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SaleRegistrationIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SaleConfirmationIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
